...
namespace BusTicketProject.Services
{
    ...
    {
        private readonly UserManager<AdminIstrative> _userManager;
        private readonly IConfiguration _config;


        public AdminIstrativeService(UserManager<AdminIstrative> userManager, IConfiguration config)
        {
        ...
        {
            var identityUser = new AdminIstrative
            {
