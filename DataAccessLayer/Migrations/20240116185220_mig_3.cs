        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PopularCompany = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VoyageID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartingPlace = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Destination = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StartingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DestinationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EsimatedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpeditionStop1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpeditionStop2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpeditionStop3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Voyages_Companies_CompanyID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(type: "int", nullable: false),
                    VoyageID1 = table.Column<int>(type: "int", nullable: true),
                    VoyageID = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Voyages_VoyageID1",
                        column: x => x.VoyageID1,
